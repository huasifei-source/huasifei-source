...
IMG_PREFIX_DATE:=$(call sanitize,$(VERSION_BUILD_DATE))-

IMG_PREFIX:=$(VERSION_DIST_SANITIZED)-$(IMG_PREFIX_DATE)$(IMG_PREFIX_VERNUM)$(IMG_PREFIX_VERCODE)$(IMG_PREFIX_EXTRA)$(BOARD)-$(SUBTARGET)
