...
define Device/vanconnect_dual-wan
  DEVICE_VENDOR := VanConnect
  DEVICE_MODEL := Dual-WAN
  DEVICE_DTS := mt7981b-vanconnect-dual-wan
  DEVICE_DTS_DIR := ../dts
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
...
endef
TARGET_DEVICES += vanconnect_dual-wan
...
define Device/huasifei_ws3006
  ...
  # ARTIFACT/bl31-uboot.fip := mt7981-bl31-uboot huasifei_ws3006
ifneq ($(CONFIG_TARGET_ROOTFS_INITRAMFS),)
  ARTIFACTS += initramfs-factory.ubi
  ARTIFACT/initramfs-factory.ubi := append-image-stage initramfs-kernel.bin | ubinize-kernel
endif
